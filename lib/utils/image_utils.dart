...
Future<void> createThumbFromImage(String inputPath, String thumbPath, int thumbWidth, int thumbHeight) async {
  ...
  await plugin.resizeFile(srcFile: inputPath, destFile: thumbPath, width: thumbWidth, height: thumbHeight, keepAspectRatio: true, format: "jpeg", quality: 100);
}
